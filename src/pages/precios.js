  ...
  return (
    ...
    <div className="shadow-lg group container  rounded-md bg-white  max-w-sm flex justify-center items-center  mx-auto content-div">
        ...
        <div className="py-8 px-4 bg-white  rounded-b-md fd-cl group-hover:opacity-25">
            ...
            <span  className="block text-gray-600 text-sm">As low as $30 per photo </span>
        </div>
        </div>
        <div className="absolute opacity-0 fd-sh group-hover:opacity-100">
       <span className="text-3xl font-bold text-white tracking-wider leading-relaxed font-sans">Classic product photos</span> 
       <div className="pt-8 text-center">
           <button className="text-center rounded-lg p-4 bg-white font-sans text-gray-700 font-bold text-lg">Learn more</button>
           </div>
    </div>
    </div>
